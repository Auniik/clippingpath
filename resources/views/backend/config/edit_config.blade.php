    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <form class="row" action="{{url('settings/update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-5">
                        <h3>Website Information</h3>
                        <div class="form-group">
                            <label for="websiteName">Website Name</label>
                            <input class="form-control @if($errors->has('website_name')) is-invalid @endif" value="{{$configRecord->website_name}}"  name="website_name" id="websiteName" type="text" placeholder="Enter website name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('website_email')) is-invalid @endif" value="{{$configRecord->website_email}}" name="website_email" id="websiteEmail" type="text" placeholder="Enter website email">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('company_name')) is-invalid @endif" value="{{$configRecord->company_name}}" name="company_name" id="companyName" type="text" placeholder="Enter company name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('licence_number')) is-invalid @endif" value="{{$configRecord->licence_number}}" name="licence_number" id="licence" type="text" placeholder="Enter Licence No.">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('address')) is-invalid @endif" value="{{$configRecord->address}}" name="address" id="address" type="text" placeholder="Enter Address">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('owner_name')) is-invalid @endif" value="{{$configRecord->owner_name}}" name="owner_name" id="owner_name" type="text" placeholder="Enter owner name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('owner_phone')) is-invalid @endif" name="owner_phone"  value="{{$configRecord->owner_phone}}" id="owner_phone" type="text" placeholder="Enter phone number">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @if($errors->has('owner_email')) is-invalid @endif" name="owner_email"  value="{{$configRecord->owner_email}}" id="owner_email" type="text" placeholder="Enter owner email">
