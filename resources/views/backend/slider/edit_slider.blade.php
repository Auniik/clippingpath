                ...
                <form class="row" action="{{route('sliders.update', $slider->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{url($slider->thumbnail_wide)}}" style=""  class="img-fluid img-thumbnail rounded edit-img-wide"  alt="Wide Image not added yet" >
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{url($slider->thumbnail_square)}}" class="img-fluid img-thumbnail rounded edit-img-square"  alt="Square Image not added yet">
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{url($slider->background_thumbnail)}}" class="img-fluid img-thumbnail rounded edit-img-bg"  alt="Background Image not added yet">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="background_text" rows="4" class="form-control @if($errors->has('background_text')) is-invalid @endif" placeholder="Enter item's description">{{$slider->background_text}}</textarea>
