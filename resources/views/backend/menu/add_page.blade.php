                ...
                <div class="tile-body col-lg-8 offset-lg-2">
                    <form action="{{url('pages')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="submenu_name" class="form-control @if($errors->has('submenu_name')) is-invalid @endif" value="{{old('submenu_name')}}" type="text" placeholder="example: Photoshop Masking" >
                            @if($errors->has('submenu_name'))
                                <div class="invalid-feedback">
                                    {{$errors->first('titsubmenu_namesubmenu_namee')}}
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="slug" class="form-control @if($errors->has('slug')) is-invalid @endif" id="exampleInputAmount" type="text" placeholder="clipping-path">
                                    @if($errors->has('slug'))
                                        <div class="invalid-feedback">
                                            {{$errors->first('slug')}}
                                        </div>
