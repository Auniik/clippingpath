...
@section('admin_content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title col-lg-8 offset-lg-2">Add Blog</h3><hr>
                <div class="tile-body col-lg-8 offset-lg-2">
                    <form action="{{url('blogs')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" class="summernote form-control @if($errors->has('description')) is-invalid @endif" placeholder="Enter description">{{old('description')}}</textarea>
