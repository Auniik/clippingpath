                ...
                <div class="row">
                    <div class="content-area">
                        <div class="col-md-9 col-md-offset-1">
                            <h2 class="content-title">{{$portfolio_item->title}}</h2>
                    ...
                    <div class="we-are service-head-area"><span class="left-shadow"></span><h3 class="we-are-head">Easy Way</h3><span class="right-shadow"></span></div><div class="easy-way-area"><div class="item-box col-md-4"><img src="{{asset('frontend/images/easy-01.png')}}"><p class="content-title">Create Job</p></div><div class="item-box col-md-4"><img src="{{asset('frontend/images/easy-02.png')}}"><p class="content-title">We Process</p></div><div class="item-box col-md-4"><img src="{{asset('frontend/images/easy-03.png')}}"><p class="content-title">You Happy</p></div></div>                <div class="we-are service-galance-area">
